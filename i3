...
font pango: Source Code Pro for Powerline Regular 12
...
bindsym $mod+d exec rofi -show run -font "Source Code Pro for Powerline Regular 14"
#
...
bindsym XF86AudioPause exec audtool --playback-playpause
...
# default workspaces
# Window assignments
# more specific assignments go first
#
assign [class="Firefox"] $workspace2
assign [class="Gvim"] $workspace3
assign [class="Keepassx"] $workspace7
...
bindsym $mod+Shift+x exec keepassx
...
# Startup apps and settings

# Start compton
exec --no-startup-id compton -b --config ~/.config/compton.conf

# Set wallpaper
exec_always --no-startup-id feh --bg-center ~/.background.jpg
